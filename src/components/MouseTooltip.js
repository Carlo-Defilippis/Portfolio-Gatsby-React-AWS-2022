...
class MouseTooltip extends React.PureComponent {
  ...
  addListener = () => {
    ...
    console.log(this.instance.getBoundingClientRect().x,
    this.instance.getBoundingClientRect().y
    )
  };
    ...
    return (
      <div
        ...
        style={{
          ...
          position: 'fixed',
          top: this.state.yPosition - this.instance.getBoundingClientRect().y,
          left: this.state.xPosition - this.instance.getBoundingClientRect().x,
          ...this.props.style,
        }}
